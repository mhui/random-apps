...
//        NSMutableDictionary *thePlayer = [listPeople objectAtIndex:indexPath.row];
//        NSLog(@"entered delete");
//        [[NSUserDefaults standardUserDefaults]setObject:thePlayer forKey:@"currentPlayerChosen"];
//        [listPeople removeObject:[[NSUserDefaults standardUserDefaults]objectForKey:@"currentPlayerChosen"]];
