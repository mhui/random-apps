...
@interface Players : UIViewController <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate, UITextFieldDelegate, UIActionSheetDelegate, UINavigationBarDelegate>
